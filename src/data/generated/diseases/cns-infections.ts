...
export const CNS_INFECTIONS: DiseaseState = {
  "id": "cns-infections",
  "name": "CNS Infections",
  "icon": "🧠",
  ...
  "subcategories": [
      ...
      "organismSpecific": [
        {
          ...
          "preferred": "Ceftriaxone 2g IV q12h (if MIC <1) + dexamethasone × 4 days",
          "alternative": "Meropenem 2g IV q8h if severe cephalosporin allergy",
          "notes": "Most common and deadliest adult meningitis pathogen (20-30% mortality). Mortality significantly reduced by adjunctive dexamethasone (de Gans trial). Check ceftriaxone MIC — if ≥1, keep vancomycin on board. Penicillin resistance via PBP alterations does NOT preclude ceftriaxone use unless ceftriaxone-specific MIC is also elevated. Duration: 10-14 days."
        },
        {
          "organism": "N. meningitidis",
          "preferred": "Ceftriaxone 2g IV q12h × 7 days",
          "alternative": "Penicillin G 4 million units IV q4h (if susceptible)",
          "notes": "Excellent prognosis with treatment (~10% mortality). POST-EXPOSURE PROPHYLAXIS for close contacts is MANDATORY: rifampin 600mg PO BID × 2 days, ciprofloxacin 500mg PO × 1 dose, or ceftriaxone 250mg IM × 1 dose. Healthcare workers with close contact (intubation, mouth-to-mouth) also need prophylaxis."
        },
        {
          "organism": "L. monocytogenes",
          "preferred": "Ampicillin 2g IV q4h ± gentamicin synergy × ≥21 days",
          "alternative": "TMP-SMX 5 mg/kg IV q6h (the ONLY reliable alternative for penicillin allergy)",
          "notes": "Intracellular pathogen — requires cell-mediated immunity for clearance. Cephalosporins, carbapenems, and fluoroquinolones are NOT reliable. STOP dexamethasone if Listeria confirmed. Rhombencephalitis (brainstem involvement) is a classic Listeria presentation."
        },
        {
          "organism": "H. influenzae (rare in vaccinated populations)",
          "preferred": "Ceftriaxone 2g IV q12h × 7 days",
          "alternative": "Meropenem, chloramphenicol",
          "notes": "Rare since Hib vaccine introduction. Still occurs in unvaccinated or under-vaccinated. Non-typeable H. influenzae can cause meningitis in elderly/immunocompromised. Duration: 7 days."
        }
      ],
      "pearls": [
      ...
      "organismSpecific": [
        {
          ...
          "preferred": "Vancomycin IV ± intraventricular vancomycin + device removal",
          "alternative": "Linezolid (excellent CSF penetration)",
          "notes": "Indolent biofilm infection on shunt tubing. Device removal is essential for cure in most cases. Rifampin can be added for biofilm activity if device is retained (similar principle to PJI)."
        },
        {
          "organism": "S. aureus (MSSA/MRSA)",
          "preferred": "Nafcillin (MSSA — better CSF penetration than cefazolin) or vancomycin (MRSA)",
          "alternative": "TMP-SMX IV (good CSF penetration for MRSA)",
          "notes": "More aggressive than CoNS. Often presents acutely with wound infection/dehiscence. Device removal strongly recommended."
        },
        {
          "organism": "Gram-negatives (Pseudomonas, Acinetobacter, Enterobacterales)",
          "preferred": "Cefepime or meropenem IV ± intraventricular aminoglycoside",
          "alternative": "For MDR: intraventricular colistin/polymyxin B",
          "notes": "Increasingly common in ICU settings. MDR gram-negative ventriculitis is one of the most challenging infections to treat. Intraventricular antibiotics are often required. Cefiderocol has emerging CNS penetration data. Consult ID."
        }
      ],
      "pearls": [
    ...
    },
    {
      ...
      "organismSpecific": [
        {
          "organism": "Streptococcus anginosus/milleri group",
          "preferred": "Ceftriaxone 2g IV q12h or penicillin G 4MU IV q4h",
          "alternative": "Meropenem 2g IV q8h",
          "notes": "THE classic brain abscess organism. S. anginosus, S. intermedius, and S. constellatus have unique propensity for abscess formation anywhere in the body (brain, liver, lung). Usually from dental/sinus contiguous spread. Typically penicillin-susceptible. Excellent prognosis with appropriate therapy + drainage."
        },
        {
          "organism": "Anaerobes (Bacteroides, Fusobacterium, Prevotella)",
          "preferred": "Metronidazole 500mg IV q8h (excellent CNS penetration)",
          "alternative": "Meropenem",
          "notes": "Often mixed with Streptococci in dental/sinus-source abscesses. Metronidazole is the drug of choice for the anaerobic component — 40-100% CSF/serum ratio, one of the best BBB-penetrating antibiotics available."
        },
        {
          "organism": "S. aureus (hematogenous or post-surgical)",
          "preferred": "Nafcillin 2g IV q4h (MSSA) or vancomycin IV (MRSA)",
          "alternative": "Linezolid or TMP-SMX for MRSA (good CNS penetration)",
          "notes": "Hematogenous S. aureus brain abscess: always evaluate for endocarditis (TEE). IMPORTANT: use nafcillin (NOT cefazolin) for MSSA brain abscess — cefazolin has poor CNS penetration."
        },
        {
          "organism": "Toxoplasma gondii (HIV/AIDS, CD4 <100)",
          "preferred": "Pyrimethamine + sulfadiazine + leucovorin × 6+ weeks",
          "alternative": "TMP-SMX (high-dose) if sulfadiazine unavailable",
          "notes": "Most common cause of brain abscess in AIDS patients. Multiple ring-enhancing lesions + positive Toxoplasma IgG + CD4 <100 = empiric treatment without biopsy. Improvement expected within 10-14 days — if no response, biopsy to rule out CNS lymphoma. After treatment: lifelong secondary prophylaxis until immune reconstitution on ART."
        },
        {
          "organism": "Nocardia (transplant, chronic steroids)",
          "preferred": "TMP-SMX (high-dose) ± imipenem or amikacin for severe disease",
          "alternative": "Linezolid (good activity and CNS penetration)",
          "notes": "Think Nocardia in any immunocompromised patient with brain + lung lesions (Nocardia disseminates from pulmonary source). Gram stain shows beaded, branching, weakly acid-fast positive gram-positive rods. Treatment duration: months to years depending on immune status."
        }
      ],
      "pearls": [
