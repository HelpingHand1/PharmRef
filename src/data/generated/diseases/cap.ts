...
export const CAP: DiseaseState = {
  ...
  "subcategories": [
      ...
      "organismSpecific": [
        {
          ...
          "preferred": "Amoxicillin 1g TID (high-dose overcomes intermediate resistance)",
          "alternative": "Doxycycline, respiratory FQ",
          "notes": "Most common bacterial cause of CAP. PCV13/PCV20 vaccine has reduced invasive disease but not eliminated it. Drug-resistant S. pneumoniae (DRSP): penicillin intermediate resistance ~20-30%, macrolide resistance ~30-40%. High-dose amoxicillin achieves PK/PD targets for intermediately resistant isolates."
        },
        {
          "organism": "Mycoplasma pneumoniae",
          "preferred": "Doxycycline 100mg BID or Azithromycin",
          "alternative": "Respiratory FQ (levofloxacin, moxifloxacin)",
          "notes": "Most common cause of 'atypical' CAP. Walking pneumonia. Younger adults (5-40 years). Can cause bullous myringitis, rash, cold agglutinins. Usually self-limited but antibiotics shorten duration. Macrolide-resistant Mycoplasma emerging (~10-15% in US, >80% in parts of Asia) — doxycycline unaffected by this resistance."
        },
        {
          "organism": "Chlamydophila pneumoniae",
          "preferred": "Doxycycline or Azithromycin",
          "alternative": "Respiratory FQ",
          "notes": "Often indistinguishable from Mycoplasma clinically. Can cause laryngitis (hoarseness is a clue). Prolonged cough. Usually mild."
        },
        {
          "organism": "Respiratory viruses (Influenza, SARS-CoV-2, RSV)",
          "preferred": "Oseltamivir (influenza), Paxlovid (COVID-19)",
        ...
        },
        {
          ...
          "preferred": "Amoxicillin-clavulanate, doxycycline",
          "alternative": "Respiratory FQ, cephalosporins",
          "notes": "Non-typeable H. influenzae is common in COPD patients. ~30-40% produce beta-lactamase → amoxicillin alone may fail. Amox-clav or doxycycline covers this. Ceftriaxone is reliable."
        }
      ],
      "pearls": [
    ...
    },
    {
      ...
      "organismSpecific": [
        {
          "organism": "S. pneumoniae (DRSP risk higher)",
          "preferred": "Amox-clav (high-dose amoxicillin component), respiratory FQ",
          "alternative": "Ceftriaxone IM/IV single dose + oral step-down",
          "notes": "Recent antibiotics select for resistant pneumococci. Prior beta-lactam → consider FQ. Prior FQ → use beta-lactam + macrolide. Don't repeat the same class within 90 days."
        },
        {
          "organism": "H. influenzae (beta-lactamase producer)",
          "preferred": "Amox-clav, cefpodoxime, doxycycline",
          "alternative": "Respiratory FQ",
          "notes": "Beta-lactamase production: ~30-40%. Amoxicillin alone insufficient. Clavulanate or cephalosporin overcomes this."
        },
        {
          "organism": "Moraxella catarrhalis",
          "preferred": "Amox-clav, cephalosporins, macrolides",
          "alternative": "Doxycycline, respiratory FQ",
          "notes": "Nearly 100% beta-lactamase positive — amoxicillin alone WILL fail. Common in COPD patients. Usually self-limited but can cause severe disease in immunocompromised."
        },
        {
          "organism": "S. aureus (MSSA post-influenza)",
          "preferred": "Amox-clav, cephalexin (MSSA)",
          "alternative": "TMP-SMX + beta-lactam if MRSA concern",
          "notes": "Post-influenza staphylococcal pneumonia is a classic lethal combination. Rapidly progressive, necrotizing. If suspected, treat aggressively — don't wait for cultures. Consider MRSA coverage (vancomycin or linezolid) if risk factors present."
        }
      ],
      "pearls": [
    ...
    },
    {
      ...
      "organismSpecific": [
        {
          "organism": "S. pneumoniae (still #1 bacterial cause)",
          "preferred": "Ceftriaxone, ampicillin (high-dose), respiratory FQ",
          "alternative": "Vancomycin (only if highly resistant — rare in US)",
          "notes": "Even with PCV13/20, still the most common identified bacterial cause of CAP. Penicillin 'resistance' in pneumonia is defined differently than meningitis — MIC breakpoint for IV penicillin in non-meningitis is ≤2 (vs ≤0.06 for meningitis). Most 'resistant' isolates are treatable with ceftriaxone or high-dose ampicillin."
        },
        {
          "organism": "Legionella pneumophila",
          "preferred": "Azithromycin 500mg daily or Levofloxacin 750mg daily",
          "alternative": "Doxycycline (less data but reasonable)",
          "notes": "Classic presentation: high fever, GI symptoms (diarrhea), hyponatremia, elevated LFTs, relative bradycardia. Urinary antigen only detects serogroup 1 (~70% of disease). Culture on BCYE agar is gold standard but rarely done. Outbreaks linked to water systems."
        },
        {
          "organism": "Mycoplasma pneumoniae",
          "preferred": "Azithromycin, Doxycycline",
          "alternative": "Respiratory FQ",
          "notes": "Less common cause of hospitalized CAP (more outpatient). When severe enough to hospitalize, doxycycline may be preferred over azithromycin given rising macrolide resistance. Extrapulmonary manifestations: encephalitis, hemolytic anemia, Stevens-Johnson Syndrome, cardiac."
        },
        {
          "organism": "Influenza A/B",
          "preferred": "Oseltamivir 75mg PO BID × 5 days",
          "alternative": "Baloxavir (single dose — useful for adherence, but less data in hospitalized severe influenza)",
          "notes": "Treat ALL hospitalized influenza patients regardless of symptom duration. Even >48h from onset, oseltamivir reduces mortality in hospitalized patients. Always add bacterial CAP coverage if concurrent bacterial pneumonia suspected (influenza + S. aureus or S. pneumoniae is a deadly combination)."
        },
        {
          "organism": "MRSA (if risk factors present)",
          "preferred": "Vancomycin (trough 15-20 or AUC/MIC 400-600) or Linezolid 600mg PO/IV BID",
          "alternative": "TMP-SMX (for mild cases, oral step-down)",
          "notes": "ATS/IDSA 2019: Only add MRSA coverage if risk factors present (prior MRSA colonization/infection, IV drug use, recent influenza, empyema/cavitation on imaging). Do NOT add empirically for all CAP. Nasal MRSA swab has excellent negative predictive value (~95%) — if negative, safely de-escalate."
        },
        {
          "organism": "Pseudomonas aeruginosa (if risk factors present)",
          "preferred": "Pip-tazo, cefepime, meropenem (IV) + Ciprofloxacin or Levofloxacin (if susceptible)",
          "alternative": "Double-cover pending susceptibilities",
          "notes": "ATS/IDSA 2019: Only add Pseudomonas coverage if VALIDATED risk factors: structural lung disease (bronchiectasis, CF), prior Pseudomonas respiratory cultures, very severe immunosuppression. Prior hospitalization alone is NOT sufficient — this was the key change from old HCAP guidelines."
        }
      ],
      "pearls": [
    ...
    },
    {
      ...
      "organismSpecific": [
        {
          "organism": "S. pneumoniae (bacteremic)",
          "preferred": "Ceftriaxone + Azithromycin (dual therapy reduces mortality in bacteremic pneumococcal CAP per observational data)",
          "alternative": "Respiratory FQ + beta-lactam",
          "notes": "Baddour et al. and Martinez et al. observational studies showed mortality benefit of combination therapy (beta-lactam + macrolide) over monotherapy in bacteremic pneumococcal CAP. The macrolide immunomodulatory effect appears to be the key — not just the antimicrobial coverage."
        },
        {
          "organism": "Legionella (severe)",
          "preferred": "Levofloxacin 750mg IV daily (preferred in severe) or Azithromycin 500mg IV daily",
          "alternative": "Combination of both for severe Legionella",
          "notes": "FQ may be preferred in severe Legionella due to intracellular killing kinetics. Legionella is the second most common identified cause of severe CAP in some series. Hyponatremia + diarrhea + high fever in a severely ill patient = think Legionella until proven otherwise."
        },
        {
          "organism": "PVL+ MRSA (necrotizing)",
          "preferred": "Vancomycin + Linezolid (some experts use both for toxin suppression) + Clindamycin (toxin suppression)",
          "alternative": "Linezolid preferred over vancomycin (suppresses PVL toxin production at ribosomal level)",
          "notes": "PVL-positive (Panton-Valentine Leukocidin) MRSA causes rapidly necrotizing, cavitary pneumonia with extremely high mortality. Often post-influenza in young, previously healthy adults. Clindamycin or linezolid suppress toxin production (ribosomal inhibitors). Vancomycin does NOT suppress toxin production — this is a critical distinction."
        },
        {
          "organism": "Pseudomonas aeruginosa",
          "preferred": "Anti-pseudomonal beta-lactam (pip-tazo, cefepime, meropenem) + anti-pseudomonal FQ or aminoglycoside",
          "alternative": "Monotherapy after susceptibilities confirmed and clinical improvement",
          "notes": "Double coverage recommended empirically in septic shock pending susceptibilities. De-escalate to monotherapy once susceptibilities confirm sensitivity. Cipro has better anti-pseudomonal activity than levo in vitro."
        }
      ],
      "pearls": [
    ...
    },
    {
      ...
      "organismSpecific": [
        {
          "organism": "Mixed oral flora (Streptococcus spp. + anaerobes)",
          "preferred": "Amp-sulbactam, amox-clav",
          "alternative": "Clindamycin, moxifloxacin",
          "notes": "The traditional teaching of 'aspiration = anaerobes' has been challenged. Modern studies using molecular diagnostics show that streptococci (viridans group, S. intermedius/anginosus group) are actually the dominant pathogens. Anaerobes play a supporting role, especially in abscess formation."
        },
        {
          "organism": "S. anginosus/intermedius/constellatus group (milleri group)",
          "preferred": "Ampicillin, amox-clav, penicillin",
          "alternative": "Ceftriaxone, clindamycin",
          "notes": "These are the streptococci most associated with abscess formation anywhere in the body — lung, brain, liver. Very common in aspiration pneumonia complicated by abscess. Usually penicillin-susceptible. If you see a lung abscess, think milleri group."
        },
        {
          "organism": "Gram-negative rods (Klebsiella, E. coli — if healthcare-associated)",
          "preferred": "Ceftriaxone, pip-tazo",
          "alternative": "Meropenem if MDR risk",
          "notes": "Healthcare-associated aspiration (nursing home, recent hospitalization) shifts the flora toward gram-negative rods. Empiric coverage should be broader. Consider local antibiogram."
        }
      ],
      "pearls": [
