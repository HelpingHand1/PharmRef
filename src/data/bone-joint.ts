...
export const BONE_JOINT = {
  ...
  overview: {
    ...
    keyGuidelines: [
      ...
      { name: "ACR/AAHKS 2023 Management of PJI Guideline", detail: "Joint rheumatology/orthopedic guideline. Conditional recommendations on DAIR eligibility, antibiotic selection, and when to pursue one-stage vs. two-stage exchange. Aligns with IDSA on rifampin for Staphylococcal PJI." },
    ],
    landmarkTrials: [
