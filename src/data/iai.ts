  ...
  "ha-iai": {
    ...
    diagnosticStewardship: [
      {
        ...
        sourceIds: ["idsa-sis-2010-ciai", "durapop"],
      },
      {
        ...
        sourceIds: ["idsa-sis-2010-ciai", "idsa-candidiasis"],
      },
    ],
    reassessmentCheckpoints: [
      ...
      },
      {
        ...
        sourceIds: ["idsa-sis-2010-ciai", "durapop", "idsa-candidiasis"],
      },
      {
        window: "definitive",
        ...
        sourceIds: ["stop-it", "durapop", "idsa-sis-2010-ciai"],
      },
    ],
    ...
    durationAnchors: [
      ...
      },
      {
        ...
        sourceIds: ["durapop", "idsa-sis-2010-ciai"],
      },
    ],
  },
  "biliary-iai": {
