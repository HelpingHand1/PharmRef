...
export const BONE_JOINT: DiseaseState = {
  "id": "bone-joint",
  ...
  "subcategories": [
      ...
      "organismSpecific": [
        {
          ...
          "preferred": "Cefazolin 2g IV q8h → oral step-down (levofloxacin + rifampin, or TMP-SMX)",
          "alternative": "Nafcillin 2g IV q4h (if cefazolin allergy)",
          "notes": "Most common organism. De-escalate from vancomycin as soon as MSSA confirmed. OVIVA-supported oral step-down with bone-penetrating agents after initial IV stabilization (typically 5-7 days). Rifampin combinations are particularly effective for bone infections but only when used with a companion drug."
        },
        {
          "organism": "S. aureus (MRSA)",
          "preferred": "Vancomycin IV (AUC-guided) → oral TMP-SMX or linezolid",
          "alternative": "Daptomycin 8-10 mg/kg IV daily",
          "notes": "Oral step-down: TMP-SMX DS 2 tabs BID is the workhorse for MRSA osteomyelitis oral therapy (good bone penetration, tolerable long-term). Linezolid 600mg BID is effective but limit duration due to myelosuppression (CBC weekly). Doxycycline 100mg BID if susceptible."
        },
        {
          "organism": "Streptococci (viridans, S. pyogenes, S. agalactiae)",
          "preferred": "Ceftriaxone 2g IV daily × 6 weeks → oral amoxicillin 1g TID",
          "alternative": "Penicillin G IV",
          "notes": "Ceftriaxone is ideal — once-daily OPAT. Oral step-down to high-dose amoxicillin works well given excellent Streptococcal susceptibility. S. agalactiae (GBS): common in elderly/diabetic vertebral osteomyelitis — often from urinary source."
        },
        {
          "organism": "Enterobacterales (E. coli, Klebsiella)",
          "preferred": "Ceftriaxone (if susceptible) → oral ciprofloxacin or levofloxacin",
          "alternative": "Ertapenem 1g IV daily (if ESBL)",
          "notes": "Fluoroquinolones have the best oral bioavailability and bone penetration for gram-negative osteomyelitis. Oral step-down to ciprofloxacin 750mg BID or levofloxacin 750mg daily is well-supported. For ESBL: ertapenem IV for OPAT, with limited oral options (discuss with ID)."
        },
        {
          "organism": "Pseudomonas aeruginosa",
          "preferred": "Cefepime 2g IV q8h or ciprofloxacin 750mg PO BID (if susceptible)",
          "alternative": "Meropenem if resistant",
          "notes": "Less common in vertebral osteomyelitis except post-procedural or IDU-associated. Ciprofloxacin is one of few oral antipseudomonal agents — makes OVIVA-style oral step-down possible. Duration: 6-8 weeks."
        },
        {
          "organism": "Culture-negative (biopsy negative despite holding antibiotics)",
          "preferred": "Vancomycin + ceftriaxone empirically × 6 weeks",
          "alternative": "Consultation with ID for atypical organisms (TB, Brucella, fungi)",
          "notes": "20-30% of biopsies are culture-negative. Consider: prior antibiotics suppressing growth, atypical organisms (Mycobacterium TB — especially in endemic areas or immunocompromised; Brucella — travel to endemic regions, livestock exposure; Coccidioides — Southwest US; Blastomyces). If culture-negative, send additional studies: AFB culture/smear, fungal culture, Brucella serologies, 16S rRNA PCR if tissue available."
        }
      ],
      "pearls": [
      ...
      "organismSpecific": [
        {
          ...
          "preferred": "Cefazolin (MSSA) or vancomycin/daptomycin (MRSA) × 3-4 weeks",
          "alternative": "TMP-SMX or linezolid for MRSA oral step-down",
          "notes": "Most common cause. Aggressive joint destruction. Prompt drainage + antibiotics. Duration 3-4 weeks if no adjacent osteomyelitis; extend to 6 weeks if bone involvement confirmed on imaging."
        },
        {
          "organism": "Streptococci (pyogenes, agalactiae, pneumoniae)",
          "preferred": "Ceftriaxone 2g IV daily → oral amoxicillin 1g TID",
          "alternative": "Penicillin G IV",
          "notes": "S. agalactiae (GBS) increasingly common in elderly/diabetic. Good prognosis with appropriate therapy. Duration: 3-4 weeks."
        },
        {
          "organism": "N. gonorrhoeae",
          "preferred": "Ceftriaxone 1g IV daily → oral step-down",
          "alternative": "Consult ID for cephalosporin allergy",
          "notes": "Think about this in every sexually active young adult with acute monoarthritis. Two forms: disseminated gonococcal infection (DGI) with migratory polyarthralgia + dermatitis-arthritis syndrome, and purulent monoarthritis. Excellent prognosis. Always test for concurrent chlamydia and treat empirically."
        },
        {
          "organism": "Gram-negatives (E. coli, Pseudomonas)",
          "preferred": "Ceftriaxone or cefepime (based on susceptibilities)",
          "alternative": "Ciprofloxacin PO for oral step-down",
          "notes": "More common in elderly, immunocompromised, IDU, and GU/GI-source bacteremia. Pseudomonas: consider in IDU (sternoclavicular joint classically). Duration: 3-4 weeks."
        }
      ],
      "pearls": [
    ...
    },
    {
      ...
      "organismSpecific": [
        {
          "organism": "Staphylococcus aureus (MSSA/MRSA)",
          "preferred": "DAIR + rifampin combination (if DAIR criteria met); two-stage exchange if chronic",
          "alternative": "Daptomycin IV for MRSA if vancomycin intolerant",
          "notes": "Most important principle: RIFAMPIN for any retained prosthetic material. For two-stage exchange, rifampin is used post-reimplantation (stage 2), not during the spacer phase."
        },
        {
          "organism": "CoNS (S. epidermidis — most common cause of delayed PJI)",
          "preferred": "Vancomycin + rifampin (most CoNS are methicillin-resistant) for DAIR; pathogen-directed for exchange",
          "alternative": "Daptomycin + rifampin",
          "notes": "S. epidermidis is THE biofilm organism. Low virulence but tenacious — forms thick biofilm on prosthetic surfaces. Usually methicillin-resistant (80-90%). Responds well to DAIR + rifampin if detected early. Delayed PJI (3-12 months) with progressive pain and loosening is the classic CoNS PJI presentation."
        },
        {
          "organism": "Cutibacterium acnes (shoulder PJI)",
          "preferred": "Penicillin G or amoxicillin × 6 weeks",
        ...
        },
        {
          ...
          "preferred": "Ceftriaxone 2g IV daily + rifampin for DAIR; ceftriaxone alone for exchange",
          "alternative": "Penicillin G or amoxicillin",
          "notes": "Good prognosis — DAIR cure rates for Streptococcal PJI are higher than Staphylococcal PJI (>80%). Rifampin still recommended for retained implants. One-stage exchange may be particularly appropriate for Streptococcal PJI."
        }
      ],
      "pearls": [
    ...
    },
    {
      ...
      "organismSpecific": [
        {
          "organism": "S. aureus (MSSA/MRSA)",
          "preferred": "Cefazolin or vancomycin (based on susceptibility)",
          "alternative": "TMP-SMX or linezolid for oral step-down",
          "notes": "Most common single organism in DFI osteomyelitis. Bone biopsy culture is the only reliable way to confirm. OVIVA-style oral step-down with appropriate agents is reasonable."
        },
        {
          "organism": "Polymicrobial (chronic DFI)",
          "preferred": "Broad-spectrum based on deep culture (e.g., pip-tazo + vancomycin)",
          "alternative": "Ertapenem + vancomycin",
          "notes": "Chronic DFI osteomyelitis is often polymicrobial — Staphylococci + Streptococci + Enterobacterales + anaerobes. This is why bone biopsy matters — treating every organism from a wound swab leads to unnecessarily broad 6-week regimens."
        }
      ],
      "pearls": [
