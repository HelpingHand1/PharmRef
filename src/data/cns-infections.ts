export const CNS_INFECTIONS = {
  ...
  overview: {
    ...
    keyGuidelines: [
      ...
      { name: "ESCMID 2016 Community-Acquired Bacterial Meningitis", detail: "European guidelines with updated evidence review. Stronger emphasis on adjunctive dexamethasone, updated duration recommendations, and management of complications (cerebral edema, hydrocephalus, vasculitis)." },
      { name: "AAN/IDSA 2008 Brain Abscess Practice Parameters", detail: "Guidance on diagnosis (ring-enhancing lesion on contrast CT/MRI), aspiration vs. excision criteria, and empiric antibiotic regimens based on suspected source (dental → anaerobes + Streptococci; otogenic → Pseudomonas + anaerobes; hematogenous → S. aureus + mixed)." },
    ],
    landmarkTrials: [
