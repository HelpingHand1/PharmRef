...
export const UTI: DiseaseState = {
  ...
  "overview": {
    ...
    "keyGuidelines": [
      {
        "name": "IDSA 2025 cUTI Guideline (NEW)",
        "detail": "First-ever IDSA guideline on complicated UTI. Introduces a 4-step empiric therapy approach (severity → resistance risk factors → patient factors → antibiogram). Supports shorter durations (FQ 5-7d, non-FQ 7d) and early IV-to-PO switch even in bacteremia. Reclassifies cUTI based on systemic symptoms, not anatomy. Endorsed by AUA, ESCMID, ASM, SAEM, SHM, SIDP, AMMI-CA.",
        "sourceIds": [
          "idsa-2025-cuti"
        ]
      },
      {
        "name": "IDSA/ESCMID 2011",
        "detail": "International Clinical Practice Guidelines for uncomplicated cystitis and pyelonephritis in women — remains relevant for uncomplicated UTI management",
        "sourceIds": [
          "idsa-escmid-2011-uti"
        ]
      },
      {
        "name": "AUA/CUA/SUFU 2019",
        "detail": "Recurrent UTI guideline — important for prophylaxis strategies",
        "sourceIds": [
          "aua-cua-sufu-2019-ruti"
        ]
      },
      {
        "name": "IDSA 2010 CAUTI",
        "detail": "Diagnosis, prevention, and treatment of catheter-associated UTI",
        "sourceIds": [
          "idsa-2010-cauti"
        ]
      },
      {
        "name": "EAU 2024",
        "detail": "European Association of Urology guidelines — frequently updated, good for emerging resistance data",
        "sourceIds": [
          "eau-2024-uti"
        ]
      }
    ...
    "landmarkTrials": [
      {
        "name": "IDSA 2025 cUTI Guideline",
        "detail": "First-ever IDSA guideline on complicated UTI. Paradigm shift: reclassifies UTI by symptoms (systemic signs) not anatomy, introduces 4-step empiric approach, endorses 7-day courses even for bacteremic UTI, formalizes IV-to-PO switch in bacteremia, and restricts novel agents to definitive therapy only.",
        "sourceIds": [
          "idsa-2025-cuti"
        ]
      },
      {
        "name": "ALTAR Trial (Harding et al., 2022)",
        "detail": "Methenamine hippurate was non-inferior to daily low-dose antibiotic prophylaxis for recurrent UTI prevention in adult women, offering a credible antibiotic-sparing prevention strategy for selected patients.",
        "sourceIds": [
          "altar-trial"
        ]
      },
      {
        "name": "Gupta et al. (2007) — Nitrofurantoin vs TMP-SMX",
        "detail": "Five days of nitrofurantoin achieved similar clinical cure to three days of TMP-SMX for acute uncomplicated cystitis, supporting nitrofurantoin as a first-line option when TMP-SMX resistance is a concern.",
        "sourceIds": [
          "gupta-2007-nitrofurantoin-tmpsmx"
        ]
      },
      {
        "name": "Gágyor et al. (2015) — Ibuprofen vs Fosfomycin",
        "detail": "Symptom-targeted ibuprofen reduced antibiotic use in uncomplicated cystitis but came with more symptom burden and pyelonephritis risk. Useful for stewardship context, but it does NOT justify routine NSAID-only treatment.",
        "sourceIds": [
          "gagyor-2015-ibuprofen-fosfomycin"
        ]
      },
      {
        "name": "Huttner et al. (2018) — Nitrofurantoin vs Fosfomycin",
        "detail": "Five days of nitrofurantoin produced higher clinical resolution than single-dose fosfomycin for uncomplicated lower UTI, reinforcing nitrofurantoin as the more dependable first-line choice when either agent is available.",
        "sourceIds": [
  ...
  "subcategories": [
    {
      ...
      "organismSpecific": [
        {
          "organism": "E. coli (75-95%)",
          "preferred": "Per empiric guidelines above — nitrofurantoin, TMP-SMX (if susceptible), fosfomycin",
          "alternative": "Cephalexin, cefpodoxime, amox-clav",
          "notes": "Dominant pathogen. Rising resistance to TMP-SMX (15-25% in US) and fluoroquinolones (10-20%). Always check local antibiogram."
        },
        {
          "organism": "Klebsiella pneumoniae (5-10%)",
          "preferred": "TMP-SMX (if susceptible), cephalexin, cefpodoxime",
          "alternative": "Amox-clav, fluoroquinolone",
          "notes": "Intrinsically resistant to ampicillin. Watch for ESBL producers. Nitrofurantoin has borderline activity — generally avoid."
        },
        {
          "organism": "Staphylococcus saprophyticus (5-10%)",
          "preferred": "Nitrofurantoin, TMP-SMX, cephalexin",
          "alternative": "Amox-clav",
          "notes": "Second most common cause in young sexually active women. Typically very susceptible. Nitrite test often NEGATIVE (doesn't reduce nitrates)."
        },
        {
          "organism": "Proteus mirabilis (3-5%)",
          "preferred": "TMP-SMX (if susceptible), amox-clav, cephalosporins",
          "alternative": "Fluoroquinolone",
          "notes": "Intrinsically resistant to nitrofurantoin. Urease producer — associated with struvite stones. Alkaline urine is a clue."
        },
        {
          "organism": "Enterococcus faecalis",
          "preferred": "Amoxicillin 500mg TID, Nitrofurantoin",
          "alternative": "Fosfomycin",
          "notes": "Intrinsically resistant to cephalosporins and TMP-SMX. Do NOT use these even if lab reports 'susceptible' for cephalosporins — this is a known lab/clinical discordance."
        }
      ],
      "pearls": [
      ...
      "organismSpecific": [
        {
          ...
          "preferred": "Carbapenems (ertapenem 1g IV daily for non-Pseudomonal; meropenem if Pseudomonas risk)",
          "alternative": "IDSA 2025 lists novel BL-BLIs for definitive therapy of confirmed ESBL. Pip-tazo controversial per MERINO trial for bacteremia but IDSA 2025 does not exclude it for UTI-source if susceptible.",
        ...
        },
        {
          ...
          "preferred": "Cefepime, pip-tazo, meropenem (IV); Ciprofloxacin (only reliable oral anti-pseudomonal)",
          "alternative": "Ceftazidime, tobramycin",
          "notes": "Culture-guided therapy essential. IDSA 2025 Step 2: if prior urine culture grew Pseudomonas, select agent with known activity. Cipro is the only oral option with reliable Pseudomonal activity — critical for step-down."
        },
        {
          "organism": "Enterococcus faecium (VRE)",
          "preferred": "Linezolid 600mg PO/IV BID, Nitrofurantoin (if cystitis only)",
          "alternative": "Fosfomycin (limited data), Daptomycin (poor urinary excretion — unreliable for UTI)",
          "notes": "Confirm true infection vs colonization. Many VRE UTIs are ASB. Linezolid achieves urinary concentrations. IDSA 2025 does not specifically address VRE UTI in the cUTI guideline — expert opinion applies."
        },
        {
          "organism": "CRE (Carbapenem-Resistant Enterobacterales)",
          "preferred": "Ceftazidime-avibactam (KPC), Meropenem-vaborbactam (KPC), Cefiderocol (MBL/broad)",
          "alternative": "Plazomicin, Imipenem-relebactam",
          "notes": "IDSA 2025 explicitly reserves these novel agents for DEFINITIVE therapy of confirmed resistant organisms. Do NOT use empirically unless prior cultures confirm CRE. Know your mechanism: KPC → ceftaz-avi or mer-vab. MBL (NDM, VIM) → cefiderocol or aztreonam + ceftaz-avi."
        }
      ],
      "pearls": [
    ...
    },
    {
      ...
      "organismSpecific": [
        {
          "organism": "E. coli (>80%)",
          "preferred": "Fluoroquinolone (outpatient) or ceftriaxone (inpatient)",
          "alternative": "TMP-SMX if susceptible (14-day course)",
          "notes": "Dominant pathogen. Bacteremia common. ESBL E. coli pyelo rising — always check prior cultures."
        },
        {
          "organism": "Proteus, Klebsiella, Enterobacter",
          "preferred": "Ceftriaxone, fluoroquinolone",
          "alternative": "Pip-tazo, carbapenems for resistant isolates",
          "notes": "Proteus + stones = think struvite/staghorn calculus. Enterobacter: avoid ceftriaxone (AmpC induction risk) — use cefepime instead."
        }
      ],
      "pearls": [
    ...
    },
    {
      ...
      "organismSpecific": [
        {
          "organism": "Polymicrobial (common in CAUTI)",
          "preferred": "Target the most pathogenic organism, not every isolate",
          "alternative": "Broad-spectrum if critically ill, then narrow",
          "notes": "CAUTI cultures are frequently polymicrobial. Not every organism needs treatment. Focus on gram-negative rods and enterococci. Coagulase-negative staph is almost always contamination in this setting."
        },
        {
          "organism": "Candida species",
          "preferred": "Remove/replace catheter — this alone may resolve candiduria",
          "alternative": "Fluconazole 200mg daily × 14 days if symptomatic and catheter removal doesn't clear",
          "notes": "DO NOT reflexively treat candiduria. Most is colonization. Treat only if: symptomatic, neutropenic, undergoing urologic procedure, or renal transplant. Echinocandins achieve poor urinary concentrations."
        }
      ],
      "pearls": [
