  ...
  "subcategories": [
    {
      ...
      "organismSpecific": [
        {
          "organism": "E. coli (most common aerobic IAI pathogen)",
          "preferred": "Ceftriaxone, cefazolin, ciprofloxacin",
          "alternative": "Pip-tazo, ertapenem",
          "notes": "E. coli causes 50-60% of community-acquired IAI. Usually susceptible to ceftriaxone, FQs, and pip-tazo. ESBL-producing E. coli is emerging in community-acquired IAI — consider if prior FQ/cephalosporin use."
        },
        {
          "organism": "Bacteroides fragilis (most common anaerobe)",
          "preferred": "Metronidazole, pip-tazo, meropenem, ampicillin-sulbactam",
          "alternative": "Ertapenem",
          "notes": "Bacteroides fragilis is universally resistant to cephalosporins and most penicillins. ALWAYS add anaerobic coverage to any cephalosporin-based IAI regimen. Metronidazole is the most targeted agent. Clindamycin has rising B. fragilis resistance (30-40%) — unreliable for IAI."
        },
        {
          "organism": "Enterococcus (biliary tract emphasis)",
          "preferred": "Ampicillin, amoxicillin, pip-tazo (inherent activity)",
          "alternative": "Vancomycin (if ampicillin-resistant)",
    ...
    },
    {
      ...
      "organismSpecific": [
        {
          "organism": "E. coli + Klebsiella (dominant aerobic gram-negatives)",
          "preferred": "Ceftriaxone, ertapenem, pip-tazo",
          "alternative": "Ciprofloxacin, meropenem (ESBL)",
          "notes": "Together cause 60-70% of aerobic IAI isolates. Community-acquired strains usually susceptible to cephalosporins and pip-tazo. ESBL prevalence rising — risk factors: prior cephalosporins/FQs, recent hospitalization, travel to endemic areas (South/Southeast Asia). If ESBL confirmed: meropenem is the gold standard (MERINO trial). Ertapenem also effective for non-Pseudomonal ESBL."
        },
        {
          "organism": "Bacteroides fragilis group",
          "preferred": "Metronidazole, pip-tazo, meropenem, ertapenem",
          "alternative": "Ampicillin-sulbactam",
          "notes": "Present in virtually all IAI from colonic sources. ALWAYS include anaerobic coverage in IAI regimens. Metronidazole is the most targeted agent and maintains >99% B. fragilis susceptibility despite decades of use. Clindamycin is NOT reliable for B. fragilis in IAI (30-40% resistance). Cephalosporins (ceftriaxone, cefepime) have NO B. fragilis activity — never use them alone for IAI."
        },
        {
          "organism": "Enterococcus faecalis",
          "preferred": "Ampicillin, pip-tazo (inherent activity), vancomycin (if resistant)",
          "alternative": "Linezolid (for VRE)",
          "notes": "THE ENTEROCOCCAL CONTROVERSY: Enterococcus is frequently cultured from IAI but its pathogenic role is debated. IDSA 2010: empiric Enterococcal coverage NOT recommended for community-acquired IAI. Cover Enterococcus empirically ONLY when: biliary source, healthcare-associated IAI, post-operative peritonitis, immunocompromised, Enterococcus in blood cultures, or failure with non-Enterococcal regimen."
        },
        {
          "organism": "Pseudomonas aeruginosa",
          "preferred": "Pip-tazo, cefepime, meropenem",
          "alternative": "Ciprofloxacin + metronidazole",
          "notes": "Uncommon in community-acquired IAI (<5% of isolates). More common in healthcare-associated IAI. IDSA 2010: empiric anti-pseudomonal coverage NOT needed for community-acquired IAI unless severe or healthcare-associated risk factors. Overtreatment of Pseudomonas in community IAI is common stewardship target."
        }
      ],
      "pearls": [
      ...
      "organismSpecific": [
        {
          ...
          "preferred": "Meropenem, ertapenem (non-Pseudomonal)",
          "alternative": "Pip-tazo (controversial — MERINO trial showed inferiority for bacteremia)",
          "notes": "ESBL prevalence in healthcare-associated IAI: 15-30%. MERINO trial caution: pip-tazo was inferior to meropenem for ESBL bacteremia. For serious ESBL IAI, carbapenems remain preferred. Ertapenem appropriate for non-critical, non-Pseudomonal ESBL IAI."
        },
        {
          "organism": "Pseudomonas aeruginosa",
          "preferred": "Pip-tazo, cefepime, meropenem",
          "alternative": "Ciprofloxacin (check susceptibility)",
          "notes": "Present in 10-20% of healthcare-associated IAI. Risk factors: prior broad-spectrum antibiotics, chronic illness, prolonged hospitalization. Double-cover empirically in septic shock; de-escalate to monotherapy when susceptibility known."
        },
        {
          "organism": "Enterococcus faecium (including VRE)",
          "preferred": "Linezolid, daptomycin",
          "alternative": "Ampicillin (if susceptible — rare for E. faecium)",
    ...
    },
    {
      ...
      "organismSpecific": [
        {
          "organism": "E. coli (50-60% of biliary infections)",
          "preferred": "Ceftriaxone, pip-tazo, ertapenem",
          "alternative": "Ciprofloxacin (if susceptible), meropenem (ESBL)",
          "notes": "Dominant biliary pathogen. Usually susceptible to cephalosporins. ESBL risk higher in patients with prior instrumentation, stents, or recent antibiotics."
        },
        {
          "organism": "Klebsiella species (15-20%)",
          "preferred": "Ceftriaxone, pip-tazo",
          "alternative": "Meropenem (ESBL/KPC)",
          "notes": "Second most common biliary aerobe. Same resistance concerns as E. coli."
        },
        {
          "organism": "Enterococcus species (10-20%)",
          "preferred": "Ampicillin, pip-tazo",
          "alternative": "Vancomycin, linezolid (VRE)",
          "notes": "Enterococcal coverage IS recommended for biliary infections (unlike non-biliary community-acquired IAI). The biliary tract is a niche where Enterococcus is a true pathogen. Ampicillin-sulbactam and pip-tazo have inherent E. faecalis activity. For E. faecium (often ampicillin-resistant): vancomycin or linezolid."
        },
        {
          "organism": "Anaerobes (Bacteroides, Clostridium)",
          "preferred": "Metronidazole, pip-tazo, meropenem",
          "alternative": "Ampicillin-sulbactam",
          "notes": "More common in complicated biliary disease: biliary-enteric anastomosis (prior surgery), elderly patients, recurrent cholangitis, emphysematous cholecystitis. Always cover when these risk factors present."
        }
      ],
      "pearls": [
